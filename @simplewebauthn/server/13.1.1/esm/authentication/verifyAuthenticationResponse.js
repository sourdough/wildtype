/* https://unpkg.com/@simplewebauthn/server@13.1.1/esm/authentication/verifyAuthenticationResponse.js?module */ import { decodeClientDataJSON } from "../helpers/decodeClientDataJSON.js";
...
export async function verifyAuthenticationResponse(options) {
  ...
  if (advancedFIDOConfig !== undefined) {
    ...
    if (fidoUserVerification === 'preferred' ||
