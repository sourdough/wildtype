/* https://unpkg.com/@simplewebauthn/server@13.1.1/esm/registration/generateRegistrationOptions.js?module */ import { generateChallenge } from "../helpers/generateChallenge.js";
...
export async function generateRegistrationOptions(options) {
  ...
  if (preferredAuthenticatorType) {
    ...
    if (preferredAuthenticatorType === 'localDevice') {
      hints.push('client-device');
      authenticatorSelection.authenticatorAttachment = 'platform';
    } else
    if (preferredAuthenticatorType === 'remoteDevice') {
      hints.push('hybrid');
      authenticatorSelection.authenticatorAttachment = 'cross-platform';
    }
  }
