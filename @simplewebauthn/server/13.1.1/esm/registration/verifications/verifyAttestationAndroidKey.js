/* https://unpkg.com/@simplewebauthn/server@13.1.1/esm/registration/verifications/verifyAttestationAndroidKey.js?module */ import { AsnParser } from "../../../../../../@peculiar/asn1-schema.js";
import { Certificate } from "../../../../../../@peculiar/asn1-x509.js";
import { id_ce_keyDescription, KeyDescription } from "../../../../../../@peculiar/asn1-android.js";
...
/**
                                                                                                         ...
                                                                                                         */
export async function verifyAttestationAndroidKey(options) {var _parsedCert$tbsCertif;
  ...
  const extKeyStore = (_parsedCert$tbsCertif = parsedCert.tbsCertificate.extensions) === null || _parsedCert$tbsCertif === void 0 ? void 0 : _parsedCert$tbsCertif.find(ext => ext.extnID === id_ce_keyDescription);
  if (!extKeyStore) {
