/* https://unpkg.com/@simplewebauthn/server@13.1.1/esm/registration/verifications/tpm/verifyAttestationTPM.js?module */ import { AsnParser } from "../../../../../../../@peculiar/asn1-schema.js";
import { Certificate, ExtendedKeyUsage, id_ce_extKeyUsage, id_ce_subjectAltName, SubjectAlternativeName } from "../../../../../../../@peculiar/asn1-x509.js";
...
export async function verifyAttestationTPM(options) {var _subjectAltNamePresen;
  ...
  parsedCert.tbsCertificate.extensions.forEach(ext => {
    ...
    if (ext.extnID === id_ce_extKeyUsage) {
  ...
  // there.
  if (!((_subjectAltNamePresen = subjectAltNamePresent[0].directoryName) !== null && _subjectAltNamePresen !== void 0 && _subjectAltNamePresen[0].length)) {
...
function getTcgAtTpmValues(root) {
  ...
  root.forEach(relName => {
    relName.forEach(attr => {
      ...
      if (attr.type === oidModel) {
        tcgAtTpmModel = attr.value.toString();
      } else
      if (attr.type === oidVersion) {
