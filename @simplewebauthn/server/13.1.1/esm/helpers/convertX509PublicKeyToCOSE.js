/* https://unpkg.com/@simplewebauthn/server@13.1.1/esm/helpers/convertX509PublicKeyToCOSE.js?module */ import { AsnParser } from "../../../../../@peculiar/asn1-schema.js";
import { Certificate } from "../../../../../@peculiar/asn1-x509.js";
import { ECParameters, id_ecPublicKey, id_secp256r1, id_secp384r1 } from "../../../../../@peculiar/asn1-ecc.js";
import { COSECRV, COSEKEYS, COSEKTY } from "./cose.js";
import { RSAPublicKey } from "../../../../../@peculiar/asn1-rsa.js";
...
export function convertX509PublicKeyToCOSE(x509Certificate) {
  ...
  if (publicKeyAlgorithmID === '1.2.840.113549.1.1.1') {
    /**
                                                         * RSA public key
                                                         */
