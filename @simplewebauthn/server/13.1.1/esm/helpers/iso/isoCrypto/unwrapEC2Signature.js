/* https://unpkg.com/@simplewebauthn/server@13.1.1/esm/helpers/iso/isoCrypto/unwrapEC2Signature.js?module */ import { AsnParser } from "../../../../../../../@peculiar/asn1-schema.js";
import { ECDSASigValue } from "../../../../../../../@peculiar/asn1-ecc.js";
...
function toNormalizedBytes(bytes, componentLength) {
  ...
  if (bytes.length === componentLength + 1 && bytes[0] === 0 && (bytes[1] & 0x80) === 0x80) {
