/* https://unpkg.com/@simplewebauthn/server@13.1.1/esm/helpers/iso/isoUint8Array.js?module */ /**
...
/**
   ...
   */
export function fromHex(hex) {var _hex$match;
  if (!hex) {
  ...
  const byteStrings = (_hex$match = hex.match(/.{1,2}/g)) !== null && _hex$match !== void 0 ? _hex$match : [];
