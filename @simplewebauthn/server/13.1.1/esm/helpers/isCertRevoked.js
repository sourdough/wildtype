/* https://unpkg.com/@simplewebauthn/server@13.1.1/esm/helpers/isCertRevoked.js?module */ import { AsnParser } from "../../../../../@peculiar/asn1-schema.js";
import { AuthorityKeyIdentifier, CertificateList, CRLDistributionPoints, id_ce_authorityKeyIdentifier, id_ce_cRLDistributionPoints, id_ce_subjectKeyIdentifier, SubjectKeyIdentifier } from "../../../../../@peculiar/asn1-x509.js";
...
/**
                               ...
                               */
export async function isCertRevoked(cert) {var _extCRLDistributionPo, _extCRLDistributionPo2, _extCRLDistributionPo3;
  ...
  extensions.forEach(ext => {
    ...
    if (ext.extnID === id_ce_cRLDistributionPoints) {
  ...
  const crlURL = (_extCRLDistributionPo = extCRLDistributionPoints) === null || _extCRLDistributionPo === void 0 ? void 0 : (_extCRLDistributionPo2 = _extCRLDistributionPo[0].distributionPoint) === null || _extCRLDistributionPo2 === void 0 ? void 0 : (_extCRLDistributionPo3 = _extCRLDistributionPo2.fullName) === null || _extCRLDistributionPo3 === void 0 ? void 0 : _extCRLDistributionPo3[0].
