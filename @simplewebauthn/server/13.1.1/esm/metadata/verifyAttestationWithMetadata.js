/* https://unpkg.com/@simplewebauthn/server@13.1.1/esm/metadata/verifyAttestationWithMetadata.js?module */ import { convertCertBufferToPEM } from "../helpers/convertCertBufferToPEM.js";
...
export async function verifyAttestationWithMetadata({ statement, credentialPublicKey, x5c, attestationStatementAlg }) {
  ...
  (authenticatorGetInfo === null || authenticatorGetInfo === void 0 ? void 0 : authenticatorGetInfo.algorithms) !== undefined) {
