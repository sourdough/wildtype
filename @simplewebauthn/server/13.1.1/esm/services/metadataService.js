...
export class BaseMetadataService {
  ...
  async initialize(opts = {}) {
    ...
    if (statements !== null && statements !== void 0 && statements.length) {
    ...
    if (mdsServers !== null && mdsServers !== void 0 && mdsServers.length) {
  ...
  setState(newState) {
    ...
    if (newState === SERVICE_STATE.REFRESHING) {
      log('MetadataService is REFRESHING');
    } else
    if (newState === SERVICE_STATE.READY) {
