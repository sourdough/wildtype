/* https://unpkg.com/@simplewebauthn/server@13.1.1/esm/services/settingsService.js?module */ import { convertCertBufferToPEM } from "../helpers/convertCertBufferToPEM.js";
...
class BaseSettingsService {
  ...
  getRootCertificates(opts) {var _this$pemCertificates;
    const { identifier } = opts;
    return (_this$pemCertificates = this.pemCertificates.get(identifier)) !== null && _this$pemCertificates !== void 0 ? _this$pemCertificates : [];
  }}
